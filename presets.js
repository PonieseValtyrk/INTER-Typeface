...
// const constantSum = 10;
// document.getElementById('xInterval').addEventListener('change', function() {
//   const xValue = this.value;
//   const yValue = constantSum - xValue;
//   document.getElementById('yInterval').value = yValue;
// });
// document.getElementById('xDotSize').addEventListener('change', function() {
//   const xValue = this.value;
//   const yValue = constantSum - xValue;
//   document.getElementById('yDotSize').value = yValue;
// });
// document.getElementById('xDotUnusedSize').addEventListener('change', function() {
//   const xValue = this.value;
//   const yValue = constantSum - xValue;
//   document.getElementById('yDotUnusedSize').value = yValue;
// });